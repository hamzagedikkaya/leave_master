  ...
  class RegistrationsController < Devise::RegistrationsController
    ...
    def update # rubocop:disable Metrics/AbcSize
      ...
      if resource_updated
        ...
        respond_with resource, location: edit_registration_path(resource_name)
      else
        clean_up_passwords resource
        set_minimum_password_length
        respond_with resource
    ...
    def sign_up_params
      ...
      params.require(resource_name).permit(:email, :password, :password_confirmation, :name_surname, :gsm, :date_of_birth)
    end
