...
module EnvironmentConfiguration
  ...
  module_function :configure_caching, :enable_caching, :disable_caching, :set_memory_store,
                  :set_cache_headers, :configure_active_storage, :configure_action_mailer,
                  :configure_deprecation_warnings, :configure_database, :configure_assets,
                  :configure_view_annotations, :configure_controller_errors
end
...
Rails.application.configure do
  ...
  EnvironmentConfiguration.configure_caching
  EnvironmentConfiguration.configure_active_storage
  EnvironmentConfiguration.configure_action_mailer
  EnvironmentConfiguration.configure_deprecation_warnings
  EnvironmentConfiguration.configure_database
  EnvironmentConfiguration.configure_assets
  EnvironmentConfiguration.configure_view_annotations
  EnvironmentConfiguration.configure_controller_errors
end
